...
## 1. [cite_start]Project Overview & Strategic Vision [cite: 2]
...
## 2. [cite_start]Operational Phases [cite: 6]
...
## 3. [cite_start]Hardware Architecture & Hardware-Software Interfacing [cite: 11]

![A-NAV Sistem Blok Diyagramı](A-NAV_Block_Diagram.png)
...
## 4. [cite_start]Advanced Engineering Solutions & Algorithmic Design [cite: 13]
...
## 5. [cite_start]Development Ecosystem [cite: 11]
